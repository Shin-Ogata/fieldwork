...
declare namespace i18n {
    ...
    export type TReturnOptionalObjects<TOpt extends TOptions> = _ReturnObjects extends true ? $SpecialObject : TOpt['returnObjects'] extends true ? $SpecialObject : never;
    export type DefaultTReturn<TOpt extends TOptions> = string | TReturnOptionalObjects<TOpt> | TReturnOptionalNull;
