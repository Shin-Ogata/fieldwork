...
export interface TestListItemViewConstructionOptions extends ListItemViewConstructionOptions{
    devId: string;
    devIndex?: number;
}

export class TestListItemView extends ListItemView {

    private readonly _template: JST;
    private readonly _devId: string;
    private readonly _index?: number;

    constructor(options: TestListItemViewConstructionOptions) {
        super(options);
