...
class Collection extends EventSource {
    ...
    set(seeds, options) {
        ...
        return singular ? retval[0] : (retval.length ? retval : undefined);
    }
    /**
