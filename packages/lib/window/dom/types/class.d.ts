 ...
 */
export interface DOM<T extends ElementBase = HTMLElement> extends DOMBase<T>, DOMProperties<T>, DOMManipulations<T>, DOMEvents<T> {
}
...
declare const DOMClass_base: import("@cdp/core-utils").MixinConstructor<typeof DOMBase, import("@cdp/core-utils").MixinClass & DOMBase<ElementBase> & DOMProperties<any> & DOMManipulations<any> & DOMEvents<any>>;
/**
