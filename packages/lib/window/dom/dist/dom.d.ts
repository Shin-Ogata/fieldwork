 ...
 */
import { MixinClass, MixinConstructor, Nil, NonFunctionPropertyNames, PlainObject, TypedData } from '@cdp/core-utils';
...
declare const DOMClass_base: MixinConstructor<typeof DOMBase, MixinClass & DOMBase<ElementBase> & DOMAttributes<any> & DOMTraversing<any> & DOMManipulation<any> & DOMStyles<any> & DOMEvents<any> & DOMScroll<any> & DOMEffects<any>>;
