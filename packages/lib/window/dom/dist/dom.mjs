...
import { safe, isFunction, className, setMixClassAttribute, isArray, isString, toTypedData, camelize, fromTypedData, mixins } from '@cdp/core-utils';
 ...
 */
class DOMClass extends mixins(DOMBase, DOMProperties, DOMManipulations, DOMEvents) {
    /**
     * private constructor
     *
     * @param elements
