...
(function (CDP_DECLARE) {
     ...
     */
    let RESULT_CODE_RANGE;
    (function (RESULT_CODE_RANGE) {
        /**
         ...
         */
        RESULT_CODE_RANGE[RESULT_CODE_RANGE["MAX"] = 1000] = "MAX";
        /**
         * @en Reserved range of framework.
         * @ja フレームワークの予約領域
         */
        RESULT_CODE_RANGE[RESULT_CODE_RANGE["RESERVED"] = 1000] = "RESERVED";
    })(RESULT_CODE_RANGE = CDP_DECLARE.RESULT_CODE_RANGE || (CDP_DECLARE.RESULT_CODE_RANGE = {}));
    /**
     ...
     * https://github.com/microsoft/TypeScript/issues/33060
     */
    let LOCAL_CODE_RANGE_GUIDE;
    (function (LOCAL_CODE_RANGE_GUIDE) {
        /**
         * @en The assignment range guideline per 1 module.
         * @ja 1モジュール当たりに割り当てるアサイン領域ガイドライン
         */
        LOCAL_CODE_RANGE_GUIDE[LOCAL_CODE_RANGE_GUIDE["MODULE"] = 100] = "MODULE";
        /**
         * @en The assignment range guideline per 1 function.
         * @ja 1機能当たりに割り当てるアサイン領域ガイドライン
         */
        LOCAL_CODE_RANGE_GUIDE[LOCAL_CODE_RANGE_GUIDE["FUNCTION"] = 20] = "FUNCTION";
    })(LOCAL_CODE_RANGE_GUIDE = CDP_DECLARE.LOCAL_CODE_RANGE_GUIDE || (CDP_DECLARE.LOCAL_CODE_RANGE_GUIDE = {}));
    /**
     ...
     * https://github.com/microsoft/TypeScript/issues/33060
     */
    let RESULT_CODE_BASE;
    (function (RESULT_CODE_BASE) {
        RESULT_CODE_BASE[RESULT_CODE_BASE["COMMON"] = 0] = "COMMON";
        RESULT_CODE_BASE[RESULT_CODE_BASE["CDP"] = 100] = "CDP";
    ...
    })(RESULT_CODE_BASE = CDP_DECLARE.RESULT_CODE_BASE || (CDP_DECLARE.RESULT_CODE_BASE = {}));
    /**
...
var RESULT_CODE_BASE = CDP_DECLARE.RESULT_CODE_BASE;
var RESULT_CODE_RANGE = CDP_DECLARE.RESULT_CODE_RANGE;
var LOCAL_CODE_RANGE_GUIDE = CDP_DECLARE.LOCAL_CODE_RANGE_GUIDE;
