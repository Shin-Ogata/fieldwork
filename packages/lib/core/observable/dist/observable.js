...
(function (global, factory) {
    ...
    class EventBrokerProxy {
        get() {
            return this._broker || (this._broker = new eventPublisher.EventBroker());
        }
    }
    /** @internal */
