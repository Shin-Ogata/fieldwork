...
export declare const request: {
    get: <T extends object | keyof AjaxDataTypeList<PlainObject> = 'json'>(url: string, data?: PlainObject, dataType?: T extends AjaxDataTypes ? T : 'json', options?: AjaxRequestOptions) => Promise<AjaxResult<T>>;
