...
(function (global, factory) {
    ...
    function createWorkerContext(src) {
        ...
        return URL$1.createObjectURL(new Blob$1([libCore.isFunction(src) ? `(${src.toString()})(self);` : src], { type: 'application/javascript' }));
    }
    /**
